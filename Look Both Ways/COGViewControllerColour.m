...
@synthesize blueSlider, redSlider, greenSlider;
...
- (void)initCapture {
    ...
    image1a = [UIImage imageNamed:@"rb_colour_cross.png"];
    image2a = [UIImage imageNamed:@"rg_colour_cross.png"];
    image3a = [UIImage imageNamed:@"gb_colour_cross.png"];
    image4a = [UIImage imageNamed:@"r_neg_button.png"];
    image5a = [UIImage imageNamed:@"g_neg_button.png"];
    image6a = [UIImage imageNamed:@"b_neg_button.png"];
    
    image1b = [UIImage imageNamed:@"rb_colour_cross_press.png"];
    image2b = [UIImage imageNamed:@"rg_colour_cross_press.png"];
    image3b = [UIImage imageNamed:@"gb_colour_cross_press.png"];
    image4b = [UIImage imageNamed:@"r_neg_button_press.png"];
    image5b = [UIImage imageNamed:@"g_neg_button_press.png"];
    image6b = [UIImage imageNamed:@"b_neg_button_press.png"];
...
-(IBAction)buttonClickedR2G:(id)sender{
    ...
    if (red2green==false) {
        ...
        red2green = true;
        [sender setImage:image2a forState:UIControlStateNormal];
        
    }else {
     
        [sender setImage:image2b forState:UIControlStateNormal];
        red2green =false;
    }
}
-(IBAction)buttonClickedR2B:(id)sender{
    ...
    if (red2blue==false) {
        ...
        [sender setImage:image1a forState:UIControlStateNormal];
        
    }else {
      
        [sender setImage:image1b forState:UIControlStateNormal];
        red2blue =false;
    }
}
-(IBAction)buttonClickedG2B:(id)sender{
    ...
    if (green2blue==false) {
        ...
        [sender setImage:image3a forState:UIControlStateNormal];
    }else {
        
        [sender setImage:image3b forState:UIControlStateNormal];
        green2blue =false;
    }
}
...
-(IBAction)buttonClickedReset:(id)sender{
    ...
    [self.buttonR2B setImage:image1a forState:UIControlStateNormal];
    [self.buttonR2G setImage:image2a forState:UIControlStateNormal];
    [self.buttonG2B setImage:image3a forState:UIControlStateNormal];
    [self.buttonRNeg setImage:image4a forState:UIControlStateNormal];
    [self.buttonGNeg setImage:image5a forState:UIControlStateNormal];
    [self.buttonBNeg setImage:image6a forState:UIControlStateNormal];
    ...
    [self.blueSlider setValue:sliderBlueValue animated:YES];
    [self.greenSlider setValue:sliderGreenValue animated:YES];
    [self.redSlider setValue:sliderRedValue animated:YES];
...
-(IBAction)buttonClickedRNeg:(id)sender{
    ...
    if (rNeg  ==false) {
        rNeg = true;
         ...
         [sender setImage:image4a forState:UIControlStateNormal];
    }else {
       
         [sender setImage:image4b forState:UIControlStateNormal];
        rNeg =false;
    }
}
-(IBAction)buttonClickedGNeg:(id)sender{
    ...
    if (gNeg  ==false) {
        ...
        [sender setImage:image5a forState:UIControlStateNormal];
    }else {
     
        [sender setImage:image5b forState:UIControlStateNormal];
        gNeg =false;
    }
}
-(IBAction)buttonClickedBNeg:(id)sender{
    ...
    if (bNeg  ==false) {
        ...
        [sender setImage:image6a forState:UIControlStateNormal];
    }else {
       
        [sender setImage:image6b forState:UIControlStateNormal];
        bNeg =false;
    }
}
#pragma mark -
