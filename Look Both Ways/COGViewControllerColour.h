...
@interface COGViewControllerColour : UIViewController <AVCaptureVideoDataOutputSampleBufferDelegate, UIImagePickerControllerDelegate>{
    ...
    UIButton *buttonR2G, *buttonR2B, *buttonG2B, *buttonRNeg, *buttonGNeg, *buttonBNeg;
    UISlider *greenSlider, *blueSlider, *redSlider;
    
    UIImage *image1a, *image2a, *image3a, *image4a, *image5a, *image6a;
    UIImage *image1b, *image2b, *image3b, *image4b, *image5b, *image6b;
}
...
-(IBAction)buttonClickedExit:(UIButton *)sender;
