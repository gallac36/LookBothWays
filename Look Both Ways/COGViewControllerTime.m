...
- (void)initCapture {
    ...
    [self.view insertSubview:_imageViewBack atIndex:0];
...
{ 
  //  NSLog(@"timerFired Time Slice @ %@", [theTimer fireDate]);
    NSLog(@" Time Slice frame count = %d", frameCount);
}
...
-(IBAction)buttonClickedExitTime:(id)sender{
