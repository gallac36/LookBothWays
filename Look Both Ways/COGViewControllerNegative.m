...
#import "COGViewControllerNegative.h"

@interface COGViewControllerNegative ()

@end

@implementation COGViewControllerNegative
...
-(void)timerFired:(NSTimer *) theTimer
{
   // NSLog(@"timerFired @ %@", [theTimer fireDate]);
    NSLog(@"Negative frame count = %d", frameCount);
}
-(IBAction)buttonClickedExitNeg:(id)sender{
